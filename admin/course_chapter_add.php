...
// print_r($_POST); exit;	
	...
	$errors = array();
	if (empty($detailAdd) || empty($sectionId) || empty($chapter_title))
	{
	...
	{   
        try
        {              
            $sql = "INSERT INTO `course_chapter`(`enterprise_id`, `section_id`, `title`, `description`,`status` ,`created_by`, `created_at`, `updated_at`) VALUES (?,?,?,?,?,?,?,?)";
            $stmt= $odb->prepare($sql);
            $stmt->execute([$enterprise_id,$sectionId,$chapter_title, $detailAdd, 1,$_SESSION['ID'],DATETIME,DATETIME ]);
...
<?php include '../sidebar.php'; ?>
		...
		{
			if(empty($errors)) {
				echo '<div class="message" id="message"><p><strong>SUCCESS: The Chapter has been added! You are now being redirected to the Listing.</strong></div><meta http-equiv="refresh" content="4;url=../admin/course_chapter.php?id='.$sectionId.'">';
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 mt-md-0 mt-4">
                                     ...
                                     <div class="col-md-12">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" name="chapter_title" class="form-control mb-3" placeholder="Title">
