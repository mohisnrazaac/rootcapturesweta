                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">Manage Quizes</li>
		...
		<!-- <div class="alert alert-arrow-right alert-icon-right alert-light-warning alert-dismissible fade show mb-4" role="alert">
                                ...
                                <table id="zero-config" class="table dt-table-hover tablenoscroll" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="col-md-2">Correct Answer</th>
			...
			if(!empty($teamsR)){
                foreach ($teamsR as $key => $getInfo) {
    				...
    				echo '<tr class="gradeA"><td>'.$getInfo['username'].'</td><td>'.$getInfo['email'].'</td><td>'.$correct.'</td>';
    				echo '<td>'.($avgcorrect*100).'%</td>';
                    ...
                    echo '<td width="70px">';
                    echo '<a href="quiz_check.php?quize='.$_GET['quize'].'&user='.base64_encode($id).'" ><button class="btn btn-outline-success  mb-2 me-4">Check</button></a>';                    
                    echo  '</td></tr>';
			     }
             }else{
