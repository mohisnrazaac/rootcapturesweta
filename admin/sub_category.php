                        ...
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Sub Category</li>
                                                        ...
                                                        <br>
                            <!-- <a class="btn btn-outline-success btn-lrg" href="#" role="button">Create Sub Category</a> -->
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                               ...
                               <table id="zero-config" class="table dt-table-hover tablenoscroll" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center col-md-4">Category Name</th>
    ...
    <?php
        if (isset($_GET['deleteId']))
        {
            ...
            echo '<div class="message" id="message"><p><strong>SUCCESS: </strong>The announcement has been deleted!</p></div>';
                ...
                $SQLSelect = $odb -> query("SELECT sub_category.*, category.name as category_name from sub_category join category on category.enterprise_id = sub_category.category_id WHERE sub_category.college_id = $college_id ORDER BY `created_at` DESC");
                ...
                if(!empty($category)){ 
                    foreach ($category as $key => $show) {
                        ...
                        echo '<tr><td>'.$titleShow.'</td><td>'.$category_name.'</td><td>'.$postedby.'</td><td><center>'.$date.'</center></td>';
                        echo'<td></td>';
