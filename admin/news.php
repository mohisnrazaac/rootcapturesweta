                        ...
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Announcements</li>
                                                        ...
                                                        <br>
                            <a class="btn btn-outline-success btn-lrg" href="../admin/addnews.php" role="button">Create A New Announcement</a>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                               ...
                               <table id="zero-config" class="table dt-table-hover tablenoscroll" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center col-md-3" scope="col">Date Updated</th>
            ...
            echo '<div class="message" id="message"><p><strong>SUCCESS: </strong>The announcement has been deleted!</p></div>';
                ...
                if(!empty($newsR)){ 
                    foreach ($newsR as $key => $show) {
                        ...
                        echo '<tr><td>'.$titleShow.'</td><td>'.$postedby.'</td><td><center>'.$date.'</center></td><td><center> <a class="btn btn-outline-warning mb-2 me-4" href="../admin/editnews.php?id='.$rowID.'">Edit</a> <a class="btn btn-outline-danger mb-2 me-4" href="../admin/news.php?deleteId='.$rowID.'" >Delete</a> </center></td></tr>';
                
                   }
                }else{
                    echo '<tr class=""><td valign="top" colspan="4" class="dataTables_empty" style="text-align:center;">There are no announcements to display,</td></tr>';
                }
    ?>
                                    </tbody>
                                </table>
