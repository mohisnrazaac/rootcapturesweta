                                  ...
                                  <div class="row">
                                    <div class="col-md-6 prevent-select">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb-3 api_name required" name="api_name" placeholder="API Name" error="Please enter api name">
                                      </div>
                                    </div>
                                    <div class="col-md-6 prevent-select">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb-3 api_key required" name="api_key" readonly  placeholder="API Key" error="Please enter api key">
