                    ...
                    <div class="account-settings-container layout-top-spacing">
                        ...
                        <div class="account-content">
                            ...
                            <div class="tab-content" id="animateLineContent-4">
                                <div class="tab-pane fade active show" id="animated-underline-dashboard" role="tabpanel" aria-labelledby="animated-underline-dashboard-tab">
                                    <div class="row">
                                      <form method="POST" >
                                                ...
                                                <div class="card mb-3">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="d-flex fw-bold small mb-3">
                                                            <span class="flex-grow-1">ANALYTICS</span>
                                                        ...
                                                        <div class="ratio ratio-21x9 mb-3">
                                                            <div id="world-map" class="jvectormap-without-padding" style="width:100%"></div>
                                                        </div>
                                                        </div>
                                                        <!-- END map -->
                                                        <!-- BEGIN row -->
                                                        <div class="row gx-4 d-none">
                                                            <!-- BEGIN col-6 -->
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing ">
                                ...
                                <div class="widget widget-activity-four">
                                   ...
                                   <div class="tab-pane fade" id="animated-underline-range-setting" role="tabpanel" aria-labelledby="animated-underline-range-setting-tab">    
                                    ...
                                    <?php
                                        $isMaintanenceMode = $user -> isMaintanenceMode($odb,$college_id); 
