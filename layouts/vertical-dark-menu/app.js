    ...
    var toggleFunction = {
        ...
        themeToggle: function (layoutName) {
            ...
            togglethemeEl.addEventListener('click', function() {
                ...
                var getLocalStorage = localStorage.getItem("app-theme");
                ...
                if (parseObj.settings.layout.darkMode) {
                    ...
                    localStorage.setItem("app-theme", JSON.stringify(newObject))
                    
                    var getUpdatedLocalObject = localStorage.getItem("app-theme");
                    ...
                    if (!getUpdatedParseObject.settings.layout.darkMode) {
                        ...
                        if (ifStarterKit) {
                            document.querySelector('.navbar-logo').setAttribute('src', '../../src/assets/img/RootCapture0.png')
                        } else {
