window.addEventListener("load", function(){
    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: true,
                logo: {
                    darkLogo: '../src/assets/img/RootCapturelogo.png',
                    lightLogo: '../src/assets/img/RootCapturelogo.png'
                }
            }
        },
        reset: false
    ...
    if (corkThemeObject.settings.layout.darkMode) {
        localStorage.setItem("app-theme", JSON.stringify(corkThemeObject));
        getcorkThemeObject = localStorage.getItem("app-theme");
        getParseObject = JSON.parse(getcorkThemeObject)
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '../../src/assets/img/RootCapturelogo.png')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
